...
public class Viaje_PlayerController : MonoBehaviour {
	...
	void Update () {
		...
		if ((gameController.GetComponent<Viaje_GameController>().gameState ==
			Viaje_GameController.GameState.Playing) &&
	...
	void ReadyRestart(){
		gameController.GetComponent<Viaje_GameController> ().gameState =
			Viaje_GameController.GameState.Ready;
	}
